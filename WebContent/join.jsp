...
<div>
	...
	<div class="formbox">
		<form action="Join" method="post">
			...
			<p>주소</p>
			<input type="text" name="address" id="address" disabled="disabled" style="background:#fff" required>
			<div id="search"></div>
	...
	// 카카오 주소
   	 // 우편번호 찾기 화면을 넣을 element
            ...
            function initLayerPosition(){
                ...
                element_layer.style.left = (((window.innerWidth || document.documentElement.clientWidth) - width)/2 - borderWidth) + '-200px';
                element_layer.style.top = (((window.innerHeight || document.documentElement.clientHeight) - height)/2 - borderWidth) + '-348px';
            }
